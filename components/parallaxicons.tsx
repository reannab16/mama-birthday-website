      ...
      <ParallaxLayer offset={0} speed={0.85}>
        <div className="bg-[#fce6e7] h-[85vh] w-[100vw] flex-col flex items-center justify-center absolute top-[100vh] z-0">
          <div className="h-[100%] w-[65%] flex-col flex items-center justify-around font-[Georgia-Pro] text-center pb-[10vh] italic text-base">
            <div>
              Please join me in celebrating this milestone so I can step into my
              fifties with my favourite people.
            </div>
            <div>
              <div>
                <FontAwesomeIcon icon={faCalendar} /> Sat May 20th 7pm
              </div>
              <div>
                <FontAwesomeIcon icon={faLocationDot} /> Café Kiku
              </div>
            </div>
            <div>
              <iframe
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3961.029556680842!2d79.85860357508916!3d6.887063118831529!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae25b735c3dc199%3A0x22ad3074b31606bc!2sKIKU%20Colombo!5e0!3m2!1sen!2suk!4v1681948900301!5m2!1sen!2suk"
                width="222"
                height="170"
                style={{ border: "0" }}
                //  allowfullscreen=""
            ...
            <div>
              Dress code: from casual to dazzle, sandals to stilettos, diamonds
              or even a tiara. There's only one rule- rock any outfit you
              choose.
            </div>
          </div>
        </div>
      ...
      <ParallaxLayer offset={0} speed={0.65}>
        <div className="bg-[#fce6e7] h-[70vh] w-[100vw] flex-col flex items-center justify-center absolute top-[180vh] z-0">
          <div className="h-[100%] w-[67%] flex-col flex items-center justify-between text-center pb-[10vh] pt-[10vh]">
            ...
            <form
              className="h-[75%] w-[95%] bg-white rounded-3xl z-10 flex items-center justify-around flex-col font-[Georgia-Pro]"
              action="https://formsubmit.co/reannab16@gmail.com"
              method="POST"
            >
              <div>
                ...
                <input
                  ...
                  name=""
                  id=""
                  className="bg-[#fce6e7] rounded-lg text-xs h-6 text-center w-[95%] text-gray-400"
              ...
              <input
                type="button"
                value="Coming"
                className="bg-[#fce6e7] rounded-lg text-sm text-gray-500 w-[40%] pt-2 pb-2"
              />
              <input
                type="button"
                value="Not Coming"
                className="bg-[#fce6e7] rounded-lg text-sm text-gray-500 pt-2 pb-2 w-[40%] mb-[10%]"
              />
              <input
                type="hidden"
                name="_next"
